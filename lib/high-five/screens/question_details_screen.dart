...
class QuestionDetailsScreen extends StatefulWidget {
  final String subject, userName, unitName, questionText;
  final int likes;
  QuestionDetailsScreen({required this.subject, required this.userName, required this.unitName, required this.questionText, required this.likes});
...
class _QuestionDetailsScreenState extends State<QuestionDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String unitName = widget.unitName;
    final String questionText = widget.questionText;
    final int likes = widget.likes;
    return Scaffold(
      appBar: AppBar(),
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            ...
            ReplyCards("どれみ", "2", "三角形の内角の和は180度ですよ", 2),
            ReplyCards("きつね", "3", "すごい！", 8),
          ],
        ),
      ),
    );
...
class ReplyCards extends StatelessWidget {
  final String userName, image, reply;
  final int likes;
  ReplyCards(this.userName, this.image, this.reply, this.likes);
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(reply, style: TextStyle(fontSize: 20),),
                    // SizedBox(height: 20,),
                    Row(
                      children: [
                        SizedBox(width: 250,),
...
//           List<ReplyCard> replyCards = [];
//           for (var studyData in posts) {
//             final currentUser = loggedInUser!.email;
//             final replyCard = ReplyCard(
